      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Abdelmadjid" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" placeholder="Tebboune" type="text" />
          </LabelInputContainer>
        </div>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="childfirstname">Child's First name</Label>
            <Input id="childfirstname" placeholder="Abdelmadjid" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="childlastname">Child's Last name</Label>
            <Input id="childlastname" placeholder="Tebboune" type="text" />
          </LabelInputContainer>
        </div>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            ...
            <Input id="age" type="number" min={3} max={12} />
            </LabelInputContainer>
        </div>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            <LabelInputContainer className="mb-4">
            ...
            <LabelInputContainer className="mb-4">
                ...
                <SelectContent>
                    <SelectItem value="halfday"> Half Day Schedule </SelectItem>
                    <SelectItem value="fullday"> Full Day Schedule </SelectItem>
                </SelectContent>
                </Select>
            </LabelInputContainer>
        </div>
